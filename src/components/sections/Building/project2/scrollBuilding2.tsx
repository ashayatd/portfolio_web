...
import SystemArchitecture2 from "./system2";
      ...
      >
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <h1 className="text-5xl font-bold leading-[1.15] mb-5 tracking-tight">
            Realtime Video
            <br />
            <span className="text-emerald-400">Teaching</span> Platform
          </h1>

          {/* Description */}
          <p className="text-sm text-gray-400 leading-relaxed mb-10 max-w-sm">
            A full-scale platform for live video teaching sessions with
            dual-user socket simulation, real-time call state management,
            payment flows, and Agora video integration.
          </p>

          {/* Feature List */}
          <div className="space-y-5 mb-8">
            {/* Feature 1: Dual-User Socket Simulation */}
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-white">
                  Dual-User Socket Simulation
                </p>
                <p className="text-xs text-gray-500">
                  Contractor + Seeker via Socket.IO
                </p>
              </div>
            </div>

            {/* Feature 2: Real-Time Call State Management */}
            <div className="flex items-start gap-3">
              <div className="w-5 h-5 flex items-center justify-center mt-0.5">
                <svg
                  className="w-4 h-4 text-emerald-400"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Server-synced timer with auto-reconnect
                </p>
              </div>
            </div>

            {/* Feature 3: Extension Request & Payment Flow */}
            <div className="flex items-start gap-3">
              <div className="w-5 h-5 flex items-center justify-center mt-0.5">
                <svg
                  className="w-4 h-4 text-emerald-400"
              ...
              <div>
                <p className="text-sm font-medium text-white">
                  Extension Request & Payment Flow
                </p>
                <p className="text-xs text-gray-500">
                  Seeker request → Payment → Call extended
                </p>
              </div>
            </div>

            {/* Feature 4: Agora Video Integration */}
            <div className="flex items-start gap-3">
              <div className="w-5 h-5 flex items-center justify-center mt-0.5">
                <svg
                  className="w-4 h-4 text-emerald-400"
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Token-based auth with force-leave handling
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="mt-8 w-[60%] h-full relative p-4">
        <div className="mt-8 h-[100%] bg-[#02a77303] border border-[#1a1a1a] rounded-2xl p-4">
          <div className="h-[32rem] flex items-center justify-center">
            <SystemArchitecture2 setShowGraph={setShowGraph} />
          </div>
        </div>
      </div>
    </div>
