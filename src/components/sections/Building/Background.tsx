...
export default function StarrySkyLayout({ children }: StarrySkyProps) {
  const starsShadow =
  ...
  const starsAfterShadow =
    "8vw 12vh 2px white, 16vw 18vh 1px white, 24vw 25vh 2px white, 33vw 15vh 1px white, 41vw 28vh 2px white, 49vw 35vh 1px white, 57vw 22vh 2px white, 65vw 42vh 1px white, 73vw 28vh 2px white, 81vw 48vh 1px white, 89vw 32vh 2px white, 97vw 45vh 1px white, 3vw 68vh 2px white, 11vw 75vh 1px white, 19vw 82vh 2px white, 27vw 88vh 1px white, 35vw 72vh 2px white, 43vw 85vh 1px white, 51vw 92vh 2px white, 59vw 78vh 1px white";

  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0d0f10] text-white">
      <div className="pointer-events-none absolute inset-0 z-0">
        <div
          className="absolute h-[1px] w-[1px] animate-twinkle bg-white"
          style={{ boxShadow: starsShadow }}
        >
          <div
            className="absolute h-[1px] w-[1px] animate-twinkle-reverse bg-white"
            style={{ boxShadow: starsAfterShadow }}
          />
        </div>
        <div className="absolute left-[-100px] top-[20%] h-[2px] w-[100px] animate-shoot bg-gradient-to-r from-white to-transparent" />
        <div className="absolute left-[-100px] top-[35%] h-[2px] w-[100px] animate-shoot bg-gradient-to-r from-white to-transparent [animation-delay:1s]" />
        <div className="absolute left-[-100px] top-[50%] h-[2px] w-[100px] animate-shoot bg-gradient-to-r from-white to-transparent [animation-delay:2s]" />
      </div>
